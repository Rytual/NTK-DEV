...
/**
 * MediaLoader - Honest Media Management System
 *
...
class MediaLoader extends EventEmitter {
  constructor(options = {}) {
    ...
    // Configure paths - these point to REAL external directories
    this.videosPath = options.videosPath || '/art/videos';
    this.imagesPath = options.imagesPath || '/art/images';
