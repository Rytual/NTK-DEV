  ...
  return (
    ...
    >
      <div className="text-center max-w-2xl">
        ...
        <h1 className="text-3xl font-bold text-white mb-4">PowerShell Terminal Module</h1>
        <p className="text-gray-400">PowerShell terminal with script library (Prompt 3 - Complete).</p>
      </div>
    </motion.div>
  );
};
